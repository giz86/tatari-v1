<?php
// Roles and Persmission View - page to manage role access and privillege assignment.
?>
...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header  with-border">
      <h3 class="box-title"><?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_employee_role');?></h3>
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <div class="row m-b-1">
          <div class="col-md-12">
            <?php $attributes = array('name' => 'add_role', 'id' => 'tat-form', 'autocomplete' => 'off');?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('tat_role_name');?>" name="role_name" type="text" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control custom-select" id="role_access" data-plugin="select_tat" name="role_access"  data-placeholder="<?php echo $this->lang->line('tat_role_access');?>">
                          <option value="">&nbsp;</option>
                          <option value="1"><?php echo $this->lang->line('tat_role_all_menu');?></option>
                          <option value="2"><?php echo $this->lang->line('tat_role_cmenu');?></option>
                        </select>
                      </div>
                    </div>
                  </div>
...
<div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('tat_list_all');?> <?php echo $this->lang->line('tat_roles');?> </h3>
  </div>
  <div class="box-body">
    ...
    <table class="datatables-demo table table-striped table-bordered" id="tat_table">
      <thead>
        <tr>
          ...
          <th><?php echo $this->lang->line('tat_role_rid');?></th>
          <th><?php echo $this->lang->line('tat_role_name');?></th>
          <th><?php echo $this->lang->line('tat_role_menu_per');?></th>
          <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('tat_role_added_date');?></th>
        </tr>
      </thead>
    </table>
  </div>
