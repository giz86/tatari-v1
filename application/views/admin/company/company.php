...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_company', 'id' => 'tat-form', 'autocomplete' => 'off');?>
        ...
        <div class="form-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_name');?>" name="name" type="text">
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    <label for="email"><?php echo $this->lang->line('tat_company_type');?></label>
                    <select class="form-control" name="company_type" data-plugin="tat_select" data-placeholder="<?php echo $this->lang->line('tat_company_type');?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_trading');?>" name="trading_name" type="text">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_registration');?>" name="registration_no" type="text">
                  </div>
                  <div class="col-md-6">
                    <label for="contact_number"><?php echo $this->lang->line('tat_contact_number');?></label>
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_contact_number');?>" name="contact_number" type="text">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_email');?>" name="email" type="email">
                  </div>
                  <div class="col-md-6">
                    <label for="website"><?php echo $this->lang->line('tat_website');?></label>
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_website_url');?>" name="website" type="text">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('tat_gtax');?>" name="tat_gtax" type="text">
              </div>
              <div class="form-group">
                ...
                <br>
                <select class="form-control" name="country" data-plugin="tat_select" data-placeholder="<?php echo $this->lang->line('tat_country');?>">
                  <option value=""><?php echo $this->lang->line('tat_select_one');?></option>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <label for="website"><?php echo $this->lang->line('tat_employee_password');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_employee_password');?>" name="password" type="text">
            </div>
            <div class="col-md-6">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="tat_table">
        <thead>
          <tr>
            ...
            <th><i class="fa fa-envelope"></i> <?php echo $this->lang->line('tat_email');?></th>
            <th><?php echo $this->lang->line('tat_city');?></th>
            <th><?php echo $this->lang->line('tat_country');?></th>
            <th><i class="fa fa-user"></i> <?php echo $this->lang->line('tat_added_by');?></th>
          </tr>
        </thead>
      </table>
    </div>
