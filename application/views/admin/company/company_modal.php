...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> <?php echo $this->lang->line('tat_edit_company');?></h4>
</div>
...
<?php echo form_open_multipart('admin/company/update/'.$company_id, $attributes, $hidden);?>
  <div class="modal-body">
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          <label for="company_name"><?php echo $this->lang->line('tat_company_name');?></label>
          <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_name');?>" name="name" type="text" value="<?php echo $name;?>">
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="email"><?php echo $this->lang->line('tat_company_type');?></label>
              <select class="form-control" name="company_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('tat_company_type');?>">
            ...
            <div class="col-md-6">
              <label for="trading_name"><?php echo $this->lang->line('tat_company_trading');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_trading');?>" name="trading_name" type="text" value="<?php echo $trading_name;?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="registration_no"><?php echo $this->lang->line('tat_company_registration');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_company_registration');?>" name="registration_no" type="text" value="<?php echo $registration_no;?>">
            </div>
            <div class="col-md-6">
              <label for="contact_number"><?php echo $this->lang->line('tat_contact_number');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_contact_number');?>" name="contact_number" type="text" value="<?php echo $contact_number;?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="email"><?php echo $this->lang->line('tat_email');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_email');?>" name="email" type="email" value="<?php echo $email;?>">
            </div>
            <div class="col-md-6">
              <label for="website"><?php echo $this->lang->line('tat_website');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_website_url');?>" name="website" value="<?php echo $website_url;?>" type="text">
            </div>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          <label for="tat_gtax"><?php echo $this->lang->line('tat_gtax');?></label>
          <input class="form-control" placeholder="<?php echo $this->lang->line('tat_gtax');?>" name="tat_gtax" value="<?php echo $government_tax;?>" type="text">
        </div>
        <div class="form-group">
          <label for="address"><?php echo $this->lang->line('tat_address');?></label>
          ...
          <br>
          <select class="form-control" name="country" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('tat_country');?>">
            <option value=""><?php echo $this->lang->line('tat_select_one');?></option>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <fieldset class="form-group">
            <label for="logo"><?php echo $this->lang->line('tat_company_logo');?></label>
            <small><?php echo $this->lang->line('tat_company_file_type');?></small> 
    ...
    <?php $module_attributes = $this->Custom_fields_model->company_tatari_module_attributes();?>
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label for="<?php echo $mattribute->attribute;?>"><?php echo $mattribute->attribute_label;?>
            <?php if($attr_val!=''):?>
            <a href="<?php echo site_url('admin/download');?>?type=custom_files&filename=<?php echo $attr_val;?>"><?php echo $this->lang->line('tat_download');?></a>
            <?php endif;?>
          </label>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary save"><?php echo $this->lang->line('tat_update');?></button>
  </div>
<?php echo form_close(); ?>
				...
				success: function(JSON)
				{
					if (JSON.error != '') {
						...
						var tat_table = $('#tat_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("admin/company/company") ?>",
								type : 'GET'
							},
							dom: 'lBfrtip',
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i> <?php echo $this->lang->line('tat_view_company');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        ...
        <tr>
          <th><?php echo $this->lang->line('tat_company_type');?></th>
        ...
        <tr>
          <th><?php echo $this->lang->line('tat_company_trading');?></th>
          <td style="display: table-cell;"><?php echo $trading_name;?></td>
        </tr>
        <tr>
          <th><?php echo $this->lang->line('tat_company_registration');?></th>
        ...
        <?php } ?>
        <tr>
          <th><?php echo $this->lang->line('tat_city');?></th>
          <td style="display: table-cell;"><?php echo $city;?></span></td>
        </tr>
        <tr>
          <th><?php echo $this->lang->line('tat_state');?></th>
          <td style="display: table-cell;"><?php echo $state;?></span></td>
        </tr>
        <tr>
          <th><?php echo $this->lang->line('tat_zipcode');?></th>
          <td style="display: table-cell;"><?php echo $zipcode;?></span></td>
        </tr>
        <tr>
          <th><?php echo $this->lang->line('tat_country');?></th>
        ...
        <tr>
          <th><?php echo $this->lang->line('tat_company_logo');?></th>
    ...
    <?php foreach($module_attributes as $mattribute):?>
      ...
      <tr>
          ...
          <img src="<?php echo base_url().'uploads/custom_files/'.$attr_val;?>" width="70px" id="u_file">&nbsp; <a href="<?php echo site_url('admin/download');?>?type=custom_files&filename=<?php echo $attr_val;?>"><?php echo $this->lang->line('tat_download');?></a>
          <?php } ?></td>
      </tr>
      <?php } else { ?>
      <tr>
