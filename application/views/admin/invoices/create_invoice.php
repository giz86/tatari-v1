  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_invoice_create');?> </h3>
      </div>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('tat_invoice_number');?>" name="invoice_number" type="text" value="INV-<?php echo '000'.$linv;?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="issued_to"><?php echo $this->lang->line('tat_issued_to');?></label>
                      <input type="text" class="form-control item_name" name="issued_to" id="issued_to" placeholder="Issued to">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="invoice_date"><?php echo $this->lang->line('tat_invoice_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_invoice_date');?>" readonly="readonly" name="invoice_date" type="text" value="">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="invoice_due_date"><?php echo $this->lang->line('tat_invoice_due_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_invoice_due_date');?>" readonly="readonly" name="invoice_due_date" type="text" value="">
                    </div>
                  </div>
                </div>
                <hr>
                                        ...
                                        <tr>
                                          <td><div class="form-group">
                                              <select name="discount_type" class="form-control discount_type">
                                                <option value="1"> <?php echo $this->lang->line('tat_flat');?></option>
                                                <option value="2"> <?php echo $this->lang->line('tat_percent');?></option>
                                              </select>
                                            </div></td>
                ...
                <div id="invoice-footer">
                  <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12 text-xs-center">
                      <button type="submit" name="invoice_submit" class="btn btn-primary pull-right my-1" style="margin-right: 5px;"><i class="fa fa fa-check-square-o"></i> <?php echo $this->lang->line('tat_submit_invoice');?></button>
                    </div>
                  </div>
                </div>
              </div>
