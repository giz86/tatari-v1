...
<div class="modal-body">
  <div class="alert alert-success">
        <strong><?php echo $this->lang->line('tat_pay_invoice_confirm');?></strong>
      </div>
      <div class="row">
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" name="status" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>">
              <option value="0" <?php if($invoice_status=='0'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_payroll_unpaid');?></option>
              <option value="1" <?php if($invoice_status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_payment_paid');?></option>
            </select>
          </div>
        </div>
      </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_change_status');?> 2 </h4>
</div>
<?php $attributes2 = array('name' => 'update_status', 'id' => 'update_status', 'autocomplete' => 'off');?>
<?php $hidden2 = array('invoice_id' => $invoice_id);?>
<?php echo form_open('admin/invoices/update_invoice_status', $attributes2, $hidden2);?>
