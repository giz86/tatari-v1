 ...
 */
$system_setting = $this->Tat_model->read_setting_info(1);
?>
  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_title_edit_invoice');?> #<?php echo $invoice_number;?> </h3>
      </div>
      <div class="box-body" aria-expanded="true" style="">
        <div class="row m-b-1">
          <div class="col-md-12">
            <?php $attributes = array('name' => 'create_invoice', 'id' => 'tat-form', 'autocomplete' => 'off', 'class' => 'form');?>
            ...
            <div class="bg-white">
              <div class="box-block">
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="invoice_date"><?php echo $this->lang->line('tat_invoice_number');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('tat_invoice_number');?>" name="invoice_number" type="text" readonly="readonly" value="<?php echo $invoice_number;?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                        <label for="issued_to"><?php echo $this->lang->line('tat_issued_to');?></label>
                        <input type="text" class="form-control item_name" name="issued_to" id="issued_to" placeholder="<?php echo $this->lang->line('tat_issued_to');?>" value="<?php echo $issued_to; ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="invoice_date"><?php echo $this->lang->line('tat_invoice_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_invoice_date');?>" readonly="readonly" name="invoice_date" type="text" value="<?php echo $invoice_date;?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="invoice_due_date"><?php echo $this->lang->line('tat_invoice_due_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_invoice_due_date');?>" readonly="readonly" name="invoice_due_date" type="text" value="<?php echo $invoice_due_date;?>">
                    </div>
                  </div>
                </div>
                <hr>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                          ...
                          <div data-repeater-item="">
                            ...
                            <div class="row item-row">
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                <label for="tat_title_tax_rate"><?php echo $this->lang->line('tat_title_tax_rate');?></label>
                                <br>
                      ...
                      <div class="form-group overflow-hidden1">
                        <div class="col-xs-12">
                          <button type="button" data-repeater-create="" class="btn btn-primary" id="add-invoice-item"> <i class="fa fa-plus"></i> <?php echo $this->lang->line('tat_title_add_item');?></button>
                        </div>
                      </div>
                      <?php
                        ...
                        <div class="col-md-5 col-sm-12">
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                <tr>
                                  <td><?php echo $this->lang->line('tat_title_sub_total2');?></td>
                                  <td class="text-xs-right"><?php echo $sc_show;?> <span class="sub_total"><?php echo $sub_total_amount;?></span></td>
                                </tr>
                                <tr>
                                  <td><?php echo $this->lang->line('tat_title_tax_c');?></td>
                                ...
                                <tr>
                                  <td colspan="2" style="border-bottom:1px solid #dddddd; padding:0px !important; text-align:left"><table class="table table-bordered">
                                      <tbody>
                                        <tr>
                                          <td width="30%" style="border-bottom:1px solid #dddddd; text-align:left"><strong><?php echo $this->lang->line('tat_discount_type');?></strong></td>
                                          <td style="border-bottom:1px solid #dddddd; text-align:center"><strong><?php echo $this->lang->line('tat_discount');?></strong></td>
                                          <td style="border-bottom:1px solid #dddddd; text-align:left"><strong><?php echo $this->lang->line('tat_discount_amount');?></strong></td>
                                        </tr>
                                        <tr>
                                          <td><div class="form-group">
                                              <select name="discount_type" class="form-control discount_type">
                                                <option value="1" <?php if($discount_type==1):?> selected="selected"<?php endif;?>> <?php echo $this->lang->line('tat_flat');?></option>
                                                <option value="2" <?php if($discount_type==2):?> selected="selected"<?php endif;?>> <?php echo $this->lang->line('tat_percent');?></option>
                                              </select>
                                            </div></td>
                              ...
                              <tr>
                                <td><?php echo $this->lang->line('tat_grand_total');?></td>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <label for="invoice_note"><?php echo $this->lang->line('tat_invoice_note');?></label>
                ...
                <div class="row no-print">
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary pull-right" name="invoice_submit" style="margin-right: 5px;"> <i class="fa fa fa-check-square-o"></i> <?php echo $this->lang->line('tat_submit_invoice');?> </button>
                  </div>
                </div>
              </div>
            </div>
