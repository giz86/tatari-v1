...
<div class="form-group" id="ajx_department">
  <label for="designation"><?php echo $this->lang->line('tat_hr_sub_department');?></label>
  <select class="select2" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_select_department');?>" name="subdepartment_id" id="aj_departments">
    <option value=""></option>
