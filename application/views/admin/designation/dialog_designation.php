...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_designation_edit');?></h4>
</div>
     ...
     <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group" id="ajx_department_modal">
          ...
          <select name="department_id" id="aj_subdepartments_model" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_select_department');?>">
            <option value=""></option>
       ...
       <div class="col-md-4">
        <div class="form-group" id="subdepartment_ajax_modal">
          ...
          <select name="subdepartment_id" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_select_department');?>">
            <option value=""></option>
