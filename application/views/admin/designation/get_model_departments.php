...
<div class="form-group" id="ajx_department_modal">
  ...
  <select class="select2" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_select_department');?>" name="department_id" id="aj_subdepartments_model">
    <option value=""></option>
