...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header  with-border">
      <h3 class="box-title"><?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_termination');?></h3>
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_termination', 'id' => 'tat-form', 'autocomplete' => 'off');?>
            ...
            <div class="row">
              ...
              <?php if($user_info[0]->user_role_id==1){ ?>
                ...
                <div class="form-group" id="employee_ajax">
                  <label for="employee"><?php echo $this->lang->line('tat_employee_terminated');?></label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_notice_date');?>" readonly name="notice_date" type="text">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="termination_date"><?php echo $this->lang->line('tat_termination_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_termination_date');?>" readonly name="termination_date" type="text">
                    </div>
                  </div>
                </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('tat_list_all');?> <?php echo $this->lang->line('left_terminations');?> </h3>
  </div>
  <div class="box-body">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="tat_table">
        <thead>
          <tr>
            ...
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('tat_notice_date');?></th>
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('tat_termination_date');?></th>
          </tr>
        </thead>
      </table>
    </div>
