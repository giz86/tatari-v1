...
<div class="box-header  with-border">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        <?php $attributes = array('name' => 'payroll_report', 'id' => 'ihr_report', 'autocomplete' => 'off', 'class' => 'add form-tat');?>
        ...
        <?php
			$data = array(
			  ...
			  'name'        => 'date_format',
			  'id'          => 'date_format',
			  'value'       => $this->Tat_model->set_date_format(date('Y-m-d')),
			  'class'       => 'form-control',
			);
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <select disabled="disabled" name="location_id" id="aj_location_id" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('left_location');?>">
                <option value="0"><?php echo $this->lang->line('tat_acc_all');?></option>
              </select>
            </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group" id="department_ajax">
                ...
                <select class="form-control" id="aj_subdepartments" name="department_id" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('left_department');?>" disabled="disabled">
                  <option value="0"><?php echo $this->lang->line('tat_acc_all');?></option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="designation"><?php echo $this->lang->line('tat_salary_month');?></label>
                <input type="text" class="form-control month_year" name="salary_month" id="salary_month" placeholder="<?php echo $this->lang->line('tat_salary_month');?>" />
              </div>
            </div>
        </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    ...
    <?php if($user_info[0]->user_role_id==1){ ?><div class="box-tools pull-right"> <a class="text-dark collapsed" data-toggle="collapse" href="#filter_tatari" aria-expanded="false">
