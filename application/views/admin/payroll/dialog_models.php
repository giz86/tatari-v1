...
if(isset($_GET['jd']) && isset($_GET['employee_id']) && $_GET['data']=='payroll_model' && $_GET['type']=='payroll_model'){ ?>
...
<div class="modal-header animated fadeInRight">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_payroll_employee_salary_details');?></h4>
</div>
<div class="modal-body animated fadeInRight">
                ...
                <div class="box box-widget widget-user-2"> 
                  ...
                  <div class="no-padding">
                    <ul class="nav nav-stacked">
                      <li><a href="javascript:void(0);"><?php echo $this->lang->line('tat_emp_id');?> <span class="pull-right"><?php echo $employee_id;?></span></a></li>
                      ...
                      <li><a href="javascript:void(0);"><?php echo $this->lang->line('tat_joining_date');?><span class="pull-right badge"><?php echo $date_of_joining;?></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
  ...
  <div class="row mb-1">
    <div class="col-sm-12 col-xs-12 col-xl-12">
      <div class="card-header text-uppercase"><b><?php echo $this->lang->line('tat_payroll_salary_details');?></b></div>
      <div class="card-block">
        <div id="accordion">
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><strong><?php echo $sl_allowances->allowance_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($eallowance_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><strong><?php echo $sl_commissions->commission_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($ecommissions_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($er_loan);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
          ...
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#statutory_deductions" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_set_statutory_deductions');?></strong> </a> </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $sl_other_payments->payments_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($epayments_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
...
else if(isset($_GET['jd']) && isset($_GET['employee_id']) && $_GET['data']=='hourly_payslip' && $_GET['type']=='read_hourly_payment'){ ?>
  ...
  <div class="row mb-1">
    <div class="col-sm-12 col-xs-12 col-xl-12">
      ...
      <div class="card-block">
        <div id="accordion">
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#basic_salary" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_daily_wages');?></strong> </a> </div>
            <div id="basic_salary" class="collapse" data-parent="#accordion" style="">
              <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_payroll_hourly_rate');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($basic_salary);?></span></td>
                      </tr>
                        <?php
						...
						?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_payroll_hours_worked_total');?>:</strong> <span class="pull-right"><?php echo $pcount;?></span></td>
                      </tr>
                      <?php $total_count = $pcount * $basic_salary;?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($total_count);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $r_loan->loan_deduction_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($r_loan->loan_deduction_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($loan_de_amount);?></span></td>
