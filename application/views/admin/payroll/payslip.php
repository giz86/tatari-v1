<?php
// Payslip Generation and Manage View
?>
  ...
  <div class="<?php echo $cmdp_1st;?>">
    <div class="box mb-4">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo $half_title.' - '.$this->lang->line('tat_payslip');?> - </strong><?php echo date("F, Y", strtotime($payment_date));?></h3>
        <div class="box-tools pull-right"> <a href="<?php echo site_url();?>admin/payroll/pdf_create/p/<?php echo $payslip_key;?>/" class="btn btn-social-icon mb-1 btn-outline-github" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('tat_payroll_download_payslip');?>"><i class="fa fa-file-pdf-o"></i></a> </div>
      </div>
      <div class="box-body">
          ...
          <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
            <tbody>
              <tr>
                ...
                <td><strong class="help-split"><?php echo $this->lang->line('tat_employee_name');?>: </strong><?php echo $first_name.' '.$last_name;?></td>
                <td><strong class="help-split"><?php echo $this->lang->line('tat_payslip_number');?>: </strong><?php echo $make_payment_id;?></td>
              </tr>
              <tr>
                <td><strong class="help-split"><?php echo $this->lang->line('tat_phone');?>: </strong><?php echo $contact_no;?></td>
                <td><strong class="help-split"><?php echo $this->lang->line('tat_joining_date');?>: </strong><?php echo $this->Tat_model->set_date_format($date_of_joining);?></td>
              </tr>
              <tr>
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <select class="form-control" name="status" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>">
            ...
            <option value=""><?php echo $this->lang->line('dashboard_tat_status');?></option>
            <option value="0" <?php if($approval_status=='0'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_not_approve_payroll_title');?></option>
            <option value="1" <?php if($approval_status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_role_first_level_approval');?></option>
            <option value="2" <?php if($approval_status=='2'):?> selected <?php endif; ?>> <?php echo $this->lang->line('tat_second_level_payroll_approver_title');?></option>
...
<div class="row m-b-1">
  <div class="col-md-6">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_payment_details');?> </h3>
      </div>
      <div class="box-body">
        <div id="accordion">
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#basic_salary" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_payroll_basic_salary');?></strong> </a> </div>
              ...
              <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_payroll_basic_salary');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($basic_salary);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_allowances" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_set_allowances');?></strong> </a> </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $sl_allowances->allowance_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($sl_allowances->allowance_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($allowance_amount);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_commissions" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_hr_commissions');?></strong> </a> </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $sl_commissions->commission_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($sl_commissions->commission_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($commissions_amount);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <?php if($count_loan > 0):?>
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_loan_deductions" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_set_loan_deductions');?></strong> </a> </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $r_loan->loan_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($r_loan->loan_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($loan_de_amount);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_statutory_deductions" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_set_statutory_deductions');?></strong> </a> </div>
                  ...
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <?php
                        ...
                        ?>
                      <tr>
                        <td><strong><?php echo $sl_statutory_deductions->deduction_title;?> :</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($single_sd);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($statutory_deductions_amount);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="card tatari-payslip mb-2">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_other_payments" aria-expanded="false"> <strong><?php echo $this->lang->line('tat_employee_set_other_payment');?></strong> </a> </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $sl_other_payments->payments_title;?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($sl_other_payments->payments_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($other_payments_amount);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="box-body">
                <div class="table-responsive">
                  <table class="table table-bordered mb-0">
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="4" align="right"><strong><?php echo $this->lang->line('tat_acc_total');?>:</strong></td>
                        <td><?php echo $this->Tat_model->currency_sign($overtime_amount);?></td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
  ...
  <div class="col-md-6">
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"> <?php echo $this->lang->line('tat_payslip_earning');?> </h3>
          </div>
          <div class="box-body">
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  ...
                  <?php } else {?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_employee_daily_wages');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($daily_wages);?></span></td>
                  </tr>
                  <?php } ?>
                  <?php if($total_allowances!=0 || $total_allowances!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_payroll_total_allowance');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($total_allowances);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($commissions_amount!=0 || $commissions_amount!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_hr_commissions');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($commissions_amount);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($total_loan!=0 || $total_loan!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_payroll_total_loan');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign(number_format($total_loan, 2, '.', ','));?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($total_overtime!=0 || $total_overtime!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_payroll_total_overtime');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($total_overtime);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($statutory_deductions_amount!=0 || $statutory_deductions_amount!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_employee_set_statutory_deductions');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($statutory_deductions_amount);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($other_payments_amount!=0 || $other_payments_amount!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_employee_set_other_payment');?>:</strong> <span class="pull-right"><?php echo $this->Tat_model->currency_sign($other_payments_amount);?></span></td>
                  </tr>
                  <?php endif;?>
                  ...
                  <tr>
                    <td><strong><?php echo $this->lang->line('tat_paid_amount');?>:</strong> <span class="pull-right"> <?php echo $this->Tat_model->currency_sign($total_net_salary);?></span></td>
                  </tr>
                  <?php endif;?>
