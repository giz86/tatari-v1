...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><strong><?php echo $this->lang->line('tat_payment_for');?></strong> <?php echo $half_title;?> <?php echo $p_month;?></h4>
</div>
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <label for="name"><?php echo $this->lang->line('tat_payroll_basic_salary');?></label>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_payroll_total_overtime');?></label>
          <input type="text" name="total_overtime" class="form-control" value="<?php echo $overtime_amount;?>" readonly="readonly">
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_employee_set_statutory_deductions');?></label>
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_employee_set_other_payment');?></label>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_payroll_net_salary');?></label>
          <input type="text" readonly="readonly" name="net_salary" class="form-control" value="<?php echo $net_salary;?>">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_payroll_payment_amount');?></label>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <span><strong>NOTE:</strong> <?php echo $this->lang->line('tat_payroll_total_allowance');?>,<?php echo $this->lang->line('tat_hr_commissions');?>,<?php echo $this->lang->line('tat_payroll_total_loan');?>,<?php echo $this->lang->line('tat_payroll_total_overtime');?>,<?php echo $this->lang->line('tat_employee_set_statutory_deductions');?>,<?php echo $this->lang->line('tat_employee_set_other_payment');?> are not editable.</span>
        </div>
      </div>
    </div> 
    <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'tatari_form', 'type' => 'submit', 'class' => $this->Tat_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('tat_pay'))); ?> </div>
  <?php echo form_close(); ?>
</div>
</div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><strong><?php echo $this->lang->line('tat_payment_for');?></strong> <?php echo $p_month;?></h4>
</div>
<div class="modal-body" style="overflow:auto; height:530px;">
   ...
   <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="hidden" name="company_id" value="<?php echo $company_id;?>" />
          <input type="hidden" name="location_id" value="<?php echo $location_id;?>" />
          <label for="name"><?php echo $this->lang->line('tat_payroll_hourly_rate');?></label>
          <input type="text" name="gross_salary" class="form-control" value="<?php echo $basic_salary;?>">
          <input type="hidden" id="emp_id" value="<?php echo $user_id?>" name="emp_id">
          <input type="hidden" value="<?php echo $user_id;?>" name="u_id">
          <input type="hidden" value="<?php echo $basic_salary;?>" name="basic_salary">
      ...
      <div class="col-md-6">
        <div class="form-group">
         <label for="name"><?php echo $this->lang->line('tat_payroll_hours_worked_total');?></label>
