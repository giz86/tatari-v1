...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header  with-border">
      <h3 class="box-title"><?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_warning');?></h3>
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_warning', 'id' => 'tat-form', 'autocomplete' => 'off');?>
            ...
            <div class="row">
              ...
              <?php if($user_info[0]->user_role_id==1){ ?>
                ...
                <div class="form-group" id="employee_ajax">
                  <label for="warning_to"><?php echo $this->lang->line('tat_warning_to');?></label>
                  <select name="warning_to" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_an_employee');?>">
                    <option value=""></option>
                  </select>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('tat_subject');?>" name="subject" type="text">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="warning_employee_ajax">
                      <label for="warning_by"><?php echo $this->lang->line('tat_warning_by');?></label>
                      <select name="warning_by" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_an_employee');?>">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_warning_date');?>" readonly name="warning_date" type="text">
                    </div>
                  </div>
                </div>
