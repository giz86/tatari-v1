      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input class="form-control edate" placeholder="<?php echo $this->lang->line('tat_transfer_date');?>" readonly name="transfer_date" type="text" value="<?php echo $transfer_date;?>">
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_status');?>">
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_view_transfer');?></h4>
</div>
<form class="m-b-1">
<div class="modal-body">
  <table class="footable-details table table-striped table-hover toggle-circle">
    <tbody>
      ...
      <tr>
        <th><?php echo $this->lang->line('tat_employee_transfer');?></th>
      ...
      <tr>
        <th><?php echo $this->lang->line('tat_transfer_date');?></th>
        <td style="display: table-cell;"><?php echo $this->Tat_model->set_date_format($transfer_date);?></td>
      </tr>
      <tr>
        <th><?php echo $this->lang->line('tat_transfer_to_department');?></th>
      ...
      <tr>
        <th><?php echo $this->lang->line('tat_transfer_to_location');?></th>
