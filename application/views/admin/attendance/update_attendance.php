      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/attendance/update_attendance', $attributes, $hidden);?>
            <?php
				$data = array(
				  'name'        => 'emp_id',
				  'id'          => 'emp_id',
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control attendance_date" placeholder="<?php echo $this->lang->line('tat_e_details_date');?>" readonly id="attendance_date" name="attendance_date" type="text" value="<?php echo date('Y-m-d');?>">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group" id="employee_ajax">
                  ...
                  <select disabled="disabled" name="employee_id" id="employee_id" class="form-control employee-data" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_an_employee');?>" required>
                  </select>
                </div>
                <?php } else {?>
    ...
    <div class="box mb-4">
      <div class="box-header">
		...
		<?php if(in_array('277',$role_resources_ids)) {?>
          <button type="button" class="btn btn-xs btn-outline-primary" id="add_attendance_btn" data-toggle="modal" style="display:none;" data-target=".add-modal-data"> <span class="ion ion-md-add"></span> <?php echo $this->lang->line('tat_add_new');?></button>
          <?php } else {?>
