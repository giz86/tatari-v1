...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_add_request_attendance_for');?> <?php echo $ful_name; ?></h4>
</div>
...
?>
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="form-group" id="employee_ajax">
                  ...
                  <select disabled="disabled" name="employee_id" id="employee_id" class="form-control employee-data" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_an_employee');?>">
                  </select>
                </div>
            </div>    
         </div> 
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="date"><?php echo $this->lang->line('tat_e_details_date');?></label>
              <input class="form-control attendance_date_m" placeholder="<?php echo $this->lang->line('tat_e_details_date');?>" readonly="true" id="attendance_date_m" name="attendance_date_m" type="text">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="clock_in"><?php echo $this->lang->line('tat_in_time');?></label>
              <input class="form-control timepicker_m" placeholder="<?php echo $this->lang->line('tat_in_time');?>" readonly="true" id="clock_in_m" name="clock_in_m" type="text">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="clock_out"><?php echo $this->lang->line('tat_out_time');?></label>
              <input class="form-control timepicker_m" placeholder="<?php echo $this->lang->line('tat_out_time');?>" readonly="true" id="clock_out_m" name="clock_out_m" type="text">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="clock_in"><?php echo $this->lang->line('tat_reason');?></label>
              <textarea class="form-control" placeholder="<?php echo $this->lang->line('tat_reason');?>" rows="3" id="tat_reason" name="tat_reason" type="text"></textarea>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('tat_save');?></button>
  </div>
<?php echo form_close(); ?>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_edit_request_attendance_for');?> <?php echo $full_name;?></h4>
</div>
  ...
  <div class="modal-body">
    <?php if($user[0]->user_role_id==1){ ?>
        <div class="row">
          ...
          <div class="form-group" id="employee_ajax">
              <label for="employee"><?php echo $this->lang->line('tat_employee');?></label>
              <select name="employee_id" id="employee_id" class="form-control employee-data" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_an_employee');?>">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <label for="date"><?php echo $this->lang->line('tat_e_details_date');?></label>
          <input class="form-control attendance_date_e" placeholder="<?php echo $this->lang->line('tat_e_details_date');?>" readonly="true" id="attendance_date_e" name="attendance_date_e" type="text" value="<?php echo $request_date;?>">
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="clock_in"><?php echo $this->lang->line('tat_in_time');?></label>
              <input class="form-control timepicker" placeholder="<?php echo $this->lang->line('tat_in_time');?>" readonly="true" name="clock_in" type="text" value="<?php echo $request_clock_in;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="clock_out"><?php echo $this->lang->line('tat_out_time');?></label>
              <input class="form-control timepicker" placeholder="<?php echo $this->lang->line('tat_out_time');?>" readonly="true" name="clock_out" type="text" value="<?php echo $request_clock_out;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="clock_in"><?php echo $this->lang->line('tat_reason');?></label>
              <textarea class="form-control" placeholder="<?php echo $this->lang->line('tat_reason');?>" rows="3" id="tat_reason" name="tat_reason" type="text"><?php echo $request_reason;?></textarea>
            </div>
          </div>
        </div>
        <?php if($user[0]->user_role_id == 1) {?>
          ...
          <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" name="status" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>">
                  <option value="1" <?php if($is_approved=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_pending');?></option>
                  <option value="2" <?php if($is_approved=='2'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_approved');?></option>
                  v<option value="3" <?php if($is_approved=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_rejected');?></option>
                </select>
          </div>
          </div>
      </div>
