...
$leave_user = $this->Tat_model->read_user_info($employee_id);
        ...
        <div class="col-md-12">
          <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('tat_leave_detail');?> </h3>
              </div>
            <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="table table-striped m-md-b-0">
                    <tbody>
                      <tr>
                        <th scope="row" style="border-top:0px;"><?php echo $this->lang->line('tat_employee');?></th>
                      ...
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_leave_type');?></th>
                        <td class="text-right"><?php echo $type;?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_applied_on');?></th>
                        <td class="text-right"><?php echo $this->Tat_model->set_date_format($created_at);?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_start_date');?></th>
                        <td class="text-right"><?php echo $this->Tat_model->set_date_format($from_date);?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_end_date');?></th>
                        <td class="text-right"><?php echo $this->Tat_model->set_date_format($to_date);?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_attachment');?></th>
                        <td class="text-right">
                        <?php if($leave_attachment!='' && $leave_attachment!='NULL'):?>
                        <a href="<?php echo site_url()?>admin/download?type=leave&filename=<?php echo $leave_attachment;?>"><?php echo $this->lang->line('tat_download');?></a>
                        <?php else:?>
                        
                        <?php endif;?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_tatari_total_days');?></th>
                        <td class="text-right">
                        <?php 
						if($is_half_day == 1){
							$leave_day_info = $this->lang->line('tat_hr_leave_half_day');
						} else {
    ...
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('tat_update_status');?> </h3>
              </div>
            <div class="box-body">
                  ...
                  <?php echo form_open('admin/attendance/update_leave_status/'.$leave_id, $attributes, $hidden);?>
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>">
                          <option value="1" <?php if($status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_pending');?></option>
                          <option value="4" <?php if($status=='4'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_role_first_level_approval');?></option>
                          <option value="2" <?php if($status=='2'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_approved');?></option>
                          <option value="3" <?php if($status=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_rejected');?></option>
                        </select>
                      </div>
                      <?php } else {?>
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="remarks"><?php echo $this->lang->line('tat_remarks');?></label>
                        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('tat_remarks');?>" name="remarks" id="remarks" cols="30" rows="5"><?php echo $remarks;?></textarea>
                      </div>
                    </div>
                  </div>
    ...
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('tat_last_taken_leave_title');?> </h3>
              </div>
            <div class="box-body">
              ...
              <div class="table-responsive" data-pattern="priority-columns">
                  <table class="table table-striped m-md-b-0">
                    <tbody>
                <?php $show_last_leave = $this->Attendance_model->employee_show_last_leave($employee_id,$leave_id); ?>
                <?php foreach($show_last_leave as $last_leave) {?>   
                <?php
					// Leave Types
					$type = $this->Attendance_model->read_leave_type_information($last_leave->leave_type_id);
					if(!is_null($type)){
					...
					if($last_leave->is_half_day == 1){
						$last_leave_day_info = $this->lang->line('tat_hr_leave_half_day');
					} else {
				...
				?>            
                      ...
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_applied_on');?></th>
                        <td class="text-right"><?php echo $this->Tat_model->set_date_format($last_leave->created_at);?></td>
                      </tr>
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('tat_tatari_total_days');?></th>
    ...
    <section id="decimal">
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"> <?php echo $this->lang->line('tat_leave_statistics');?> </h3>
              </div>
            <div class="box-body">
              <div class="box-block card-dashboard">
