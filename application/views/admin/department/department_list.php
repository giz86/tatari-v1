  ...
  <div class="col-md-4">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_department');?> </h3>
      </div>
      <div class="box-body">
        <?php $attributes = array('name' => 'add_department', 'id' => 'tat-form', 'autocomplete' => 'off');?>
        ...
        <div class="form-group" id="employee_ajax">
          <label for="name"><?php echo $this->lang->line('tat_department_head');?></label>
          <select disabled="disabled" name="employee_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_department_head');?>">
            <option value=""></option>
          </select>
        </div>
  ...
  <div class="<?php echo $colmdval;?>">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_list_all');?> <?php echo $this->lang->line('tat_departments');?> </h3>
      </div>
      <div class="box-body">
          ...
          <table class="datatables-demo table table-striped table-bordered" id="tat_table">
            <thead>
              <tr>
                ...
                <th><?php echo $this->lang->line('tat_department_name');?></th>
