...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header with-border">
      <h3 class="box-title"><?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_expense');?></h3>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="expense_type"><?php echo $this->lang->line('tat_expense_type');?></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_purchase_date');?>" readonly name="purchase_date" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="amount"><?php echo $this->lang->line('tat_amount');?></label>
                    <input class="form-control" placeholder="<?php echo $this->lang->line('tat_amount');?>" name="amount" type="number" value="">
                  </div>
                </div>
              </div>
              <div class="row">
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('tat_list_all');?> <?php echo $this->lang->line('tat_expenses');?> </h3>
  </div>
  <div class="box-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="tat_table">
        <thead>
          <tr>
            <th width="110"><?php echo $this->lang->line('tat_action');?></th>
            <th><?php echo $this->lang->line('tat_expense');?></th>
            <th><?php echo $this->lang->line('left_company');?></th>
            <th><i class="fa fa-dollar"></i> <?php echo $this->lang->line('tat_amount');?></th>
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('tat_purchase_date');?></th>
          </tr>
        </thead>
      </table>
    </div>
