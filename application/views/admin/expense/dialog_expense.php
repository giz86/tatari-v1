    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="employee"><?php echo $this->lang->line('tat_expense_type');?></label>
          <select name="expense_type" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_choose_expense_type');?>...">
            <option value=""></option>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="purchase_date"><?php echo $this->lang->line('tat_purchase_date');?></label>
              <input class="form-control edate" placeholder="<?php echo $this->lang->line('tat_purchase_date');?>" readonly="true" name="purchase_date" type="text" value="<?php echo $purchase_date;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="amount"><?php echo $this->lang->line('tat_amount');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_amount');?>" name="amount" type="number" value="<?php echo $amount;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control" name="company_id" id="ajx_company" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('left_company');?>">
                <option value=""></option>
          ...
          <div class="col-md-6">
            <div class="form-group" id="employee_ajx">
              ...
              <label for="gift"><?php echo $this->lang->line('tat_purchased_by');?></label>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>...">
            <option value="0" <?php if($status=='0'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_pending');?></option>
            <option value="1" <?php if($status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_approved');?></option>
            <option value="2" <?php if($status=='2'):?> selected <?php endif; ?> ><?php echo $this->lang->line('tat_cancel');?></option>
          </select>
        </div>
      </div>
      <div class="col-md-6">
        <div class='form-group'>
          <fieldset class="form-group">
            <label for="logo"><?php echo $this->lang->line('tat_bill_copy');?></label>
            <input type="file" class="form-control-file" id="bill_copy" name="bill_copy">
            <small><?php echo $this->lang->line('tat_expense_allow_files');?></small>
          </fieldset>
          <?php if($billcopy_file!='' && $billcopy_file!='no file') {?>
          <br />
          <a href="<?php echo site_url("hr/download?type=expense&filename=".$billcopy_file."") ?>"><?php echo $this->lang->line('tat_download_file');?></a>
          <?php } ?>
        </div>
      </div>
    </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_view_expense');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="table-responsive" data-pattern="priority-columns">
      <table class="footable-details table table-striped table-hover toggle-circle">
        <tbody>
          ...
          <tr>
            <th><?php echo $this->lang->line('tat_expense_type');?></th>
          ...
          <tr>
            <th><?php echo $this->lang->line('tat_purchase_date');?></th>
            <td style="display: table-cell;"><?php echo $purchase_date;?></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('tat_amount');?></th>
            <td style="display: table-cell;"><?php echo $this->Tat_model->currency_sign($amount);?></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('tat_purchased_by');?></th>
          ...
          <tr>
            ...
            <td style="display: table-cell;"><?php if($status=='0'): $e_status = $this->lang->line('tat_pending'); ?>
              <?php endif; ?>
              <?php if($status=='1'): $e_status = $this->lang->line('tat_approved');?>
              <?php endif; ?>
              <?php if($status=='2'): $e_status = $this->lang->line('tat_cancel');?>
              <?php endif; ?>
              <?php echo $e_status;?></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('tat_bill_copy');?></th>
            <td style="display: table-cell;">
			  <?php $role_resources_ids = $this->Tat_model->user_role_resource();?>
			  <?php if(in_array('314',$role_resources_ids)) { ?>
				  <?php if($billcopy_file!='' && $billcopy_file!='no file') {?>
                  	<a href="<?php echo site_url("admin/download?type=expense&filename=".$billcopy_file."") ?>"><?php echo $this->lang->line('tat_download_file');?></a>
                  <?php } ?>
              <?php } ?>
              </td>
          </tr>
