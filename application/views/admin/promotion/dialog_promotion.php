...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_edit_promotion');?></h4>
</div>
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="tat_promotion_title"><?php echo $this->lang->line('tat_promotion_title');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_promotion_title');?>" name="title" type="text" value="<?php echo $title;?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control d_date" placeholder="<?php echo $this->lang->line('tat_promotion_date');?>" readonly name="promotion_date" type="text" value="<?php echo $promotion_date;?>" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-12">
          <div class="form-group">
          <label for="reason"><?php echo $this->lang->line('tat_description');?></label>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_view_promotion');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        ...
        <tr>
          <th><?php echo $this->lang->line('tat_promotion_for');?></th>
        ...
        <tr>
          <th><?php echo $this->lang->line('tat_promotion_date');?></th>
          <td style="display: table-cell;"><?php echo $this->Tat_model->set_date_format($promotion_date);?></td>
        </tr>
        <tr>
