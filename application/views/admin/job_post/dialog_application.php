...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_jobs_cover_letter_for').' '.$result[0]->job_title;?></h4>
</div>
<form class="m-b-1">
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_change_status');?></h4>
</div>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" name="status" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('dashboard_tat_status');?>">
              <option value="0" <?php if($application_status=='0'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_pending');?></option>
              <option value="1" <?php if($application_status=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_primary_selected');?></option>
              <option value="2" <?php if($application_status=='2'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_call_for_interview');?></option>
              <option value="3" <?php if($application_status=='3'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_confirm_del');?></option>
              <option value="4" <?php if($application_status=='4'):?> selected <?php endif; ?>><?php echo $this->lang->line('tat_rejected');?></option>
            </select>
          </div>
        </div>
      </div>
