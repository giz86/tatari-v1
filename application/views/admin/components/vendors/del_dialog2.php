...
<div class="modal fadeInUp payroll_model_modal default-modal animated " id="payroll_model_modal" role="dialog" aria-labelledby="detail-modal-data" aria-hidden="true">
  <div class="modal-dialog">
