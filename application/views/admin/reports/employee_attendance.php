...
<div class="row m-b-1 <?php echo $get_animate;?>">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/reports/attendance_tat', $attributes, $hidden);?>
            <?php
                    $data = array(
                      'name'        => 'user_id',
                      'id'          => 'user_id',
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <select class="form-control" name="company_id" id="aj_company" data-plugin="select_tat" data-placeholder="Company" required>
                    <option value=""></option>
  ...
  <div class="col-md-9 <?php echo $get_animate;?>">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('tat_view');?> <?php echo $this->lang->line('tat_hr_reports_attendance_employee');?> </h3>
      </div>
      <div class="box-body">
