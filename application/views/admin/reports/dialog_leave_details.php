...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $_GET['leave_opt'].' '.$this->lang->line('tat_leave_detail');?></h4>
</div>
<form class="m-b-1">
        ...
        <table class="datatables-demo table table-striped table-bordered" id="tat_table">
          <thead>
            <tr>
              ...
              <th><?php echo $this->lang->line('dashboard_tat_end_date');?></th>
          ...
          <?php
			...
			$end_date = $this->Tat_model->set_date_format($r->to_date);
			?>
