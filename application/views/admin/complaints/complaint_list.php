...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header  with-border">
      <h3 class="box-title"><?php echo $this->lang->line('tat_add_new');?> <?php echo $this->lang->line('tat_complaint');?></h3>
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_complaint', 'id' => 'tat-form', 'autocomplete' => 'off');?>
            ...
            <div class="row">
              ...
              <?php if($user_info[0]->user_role_id==1){ ?>
                ...
                <div class="form-group" id="employee_ajax">
                  <label for="employee"><?php echo $this->lang->line('tat_complaint_from');?></label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('tat_complaint_title');?>" name="title" type="text">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="complaint_date"><?php echo $this->lang->line('tat_complaint_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('tat_complaint_date');?>" readonly name="complaint_date" type="text">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group" id="complaint_employee_ajax">
                      <label for="complaint_against"><?php echo $this->lang->line('tat_complaint_against');?></label>
  ...
  <div class="box-body">
    <div class="box-datatable table-responsive">
      <table class="datatables-demo table table-striped table-bordered" id="tat_table">
        <thead>
          <tr>
            <th style="width:96px;"><?php echo $this->lang->line('tat_action');?></th>
            <th width="280"><i class="fa fa-user"></i> <?php echo $this->lang->line('tat_complaint_from');?></th>
