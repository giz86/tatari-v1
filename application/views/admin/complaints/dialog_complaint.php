...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_edit_complaint');?></h4>
</div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="title"><?php echo $this->lang->line('tat_complaint_title');?></label>
            <input class="form-control" placeholder="<?php echo $this->lang->line('tat_complaint_title');?>" name="title" type="text" value="<?php echo $title;?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="complaint_date"><?php echo $this->lang->line('tat_complaint_date');?></label>
            <input class="form-control d_date" placeholder="<?php echo $this->lang->line('tat_complaint_date');?>" readonly name="complaint_date" type="text" value="<?php echo $complaint_date;?>">
          </div>
        </div>
      </div>
      <div class="row">
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_view_complaint');?></h4>
</div>
<form class="m-b-1">
<div class="modal-body">
  <table class="footable-details table table-striped table-hover toggle-circle">
    <tbody>
      ...
      <tr>
        <th><?php echo $this->lang->line('tat_complaint_from');?></th>
      ...
      <tr>
        <th><?php echo $this->lang->line('tat_complaint_date');?></th>
        <td style="display: table-cell;"><?php echo $this->Tat_model->set_date_format($complaint_date);?></td>
      </tr>
      <tr>
        <th><?php echo $this->lang->line('tat_complaint_against');?></th>
        <td style="display: table-cell;"><?php foreach($all_employees as $employee) {?>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php if($attachment!='' && $attachment!='no file') {?>
          <img src="<?php echo base_url().'uploads/complaints/'.$attachment;?>" width="70px" id="u_file">&nbsp; <a href="<?php echo site_url()?>admin/download?type=complaints&filename=<?php echo $attachment;?>"><?php echo $this->lang->line('tat_download');?></a>
          <?php } ?></td>
      </tr>
      <tr>
