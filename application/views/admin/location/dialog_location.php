    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <label for="company_name"><?php echo $this->lang->line('tat_edit_company');?></label>
          <select class="form-control" name="company" id="ajx_company" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_edit_company');?>">
            <option value=""><?php echo $this->lang->line('tat_edit_company');?></option>
        ...
        <?php } ?>
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('tat_location_name');?></label>
          <input class="form-control" placeholder="<?php echo $this->lang->line('tat_location_name');?>" name="name" type="text" value="<?php echo $location_name;?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="phone"><?php echo $this->lang->line('tat_phone');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_phone');?>" name="phone" type="text" value="<?php echo $phone;?>">
            </div>
            <div class="col-md-6">
              <label for="tat_faxn"><?php echo $this->lang->line('tat_faxn');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('tat_faxn');?>" name="fax" type="text" value="<?php echo $fax;?>">
            </div>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group" id="employee_ajx">
          <div class="row">
            <div class="col-md-12">
              ...
              <label for="email"><?php echo $this->lang->line('tat_view_locationh');?></label>
              <select class="form-control" name="location_head" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_view_locationh');?>">
        ...
        <div class="form-group">
          ...
          <br>
          <select class="form-control" name="country" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_country');?>">
            <option value=""><?php echo $this->lang->line('tat_select_one');?></option>
...
<?php echo form_close(); ?>
<link rel="stylesheet" href="<?php echo base_url();?>assets/tatari_assets/vendor/select2/dist/css/select2.min.css">
<script type="text/javascript" src="<?php echo base_url();?>assets/tatari_assets/vendor/select2/dist/js/select2.min.js"></script> 
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_view_location');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="table-responsive" data-pattern="priority-columns">
      <table class="footable-details table table-striped table-hover toggle-circle">
        <tbody>
          ...
          <tr>
            <th><?php echo $this->lang->line('tat_location_name');?></th>
            <td style="display: table-cell;"><?php echo $location_name;?></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('tat_view_locationh');?></th>
          ...
          <tr>
            <th><?php echo $this->lang->line('tat_phone');?></th>
            <td style="display: table-cell;"><?php echo $phone;?></span></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('tat_faxn');?></th>
