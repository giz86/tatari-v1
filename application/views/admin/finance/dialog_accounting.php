...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_acc_edit_account');?></h4>
</div>
...
<?php echo form_open('admin/finance/bankcash_update/'.$bankcash_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        <label for="account_name"><?php echo $this->lang->line('tat_acc_account_name');?></label>
        <input type="text" class="form-control" name="account_name" placeholder="<?php echo $this->lang->line('tat_acc_account_name');?>" value="<?php echo $account_name;?>">
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="account_balance"><?php echo $this->lang->line('tat_acc_initial_balance');?></label>
            <input type="text" class="form-control" name="account_balance" placeholder="<?php echo $this->lang->line('tat_acc_initial_balance');?>" value="<?php echo $account_balance;?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="account_number"><?php echo $this->lang->line('tat_e_details_acc_number');?></label>
            <input type="text" class="form-control" name="account_number" placeholder="<?php echo $this->lang->line('tat_e_details_acc_number');?>" value="<?php echo $account_number;?>">
          </div>
        </div>
      </div>
      <div class="form-group">
        <label for="branch_code"><?php echo $this->lang->line('tat_acc_branch_code');?></label>
        <input type="text" class="form-control" name="branch_code" placeholder="<?php echo $this->lang->line('tat_acc_branch_code');?>" value="<?php echo $branch_code;?>">
      </div>
    </div>
    <div class="col-md-6">
      <label for="description"><?php echo $this->lang->line('tat_e_details_bank_branch');?></label>
      <textarea class="form-control" name="bank_branch" placeholder="<?php echo $this->lang->line('tat_e_details_bank_branch');?>" rows="5"><?php echo $bank_branch;?></textarea>
    </div>
  </div>
</div>
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var tat_table = $('#tat_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("admin/finance/bank_cash_list") ?>",
								type : 'GET'
							},
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_invoice_no').' '.$invoice_number;?></h4>
</div>
...
<?php echo form_open('admin/finance/add_invoice_payment/'.$invoice_id, $attributes, $hidden);?>
<?php else:?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data">Direct <?php echo $this->lang->line('tat_invoice_no').' '.$invoice_number;?></h4>
</div>
<?php $attributes = array('name' => 'add_payment', 'id' => 'add_payment', 'autocomplete' => 'off');?>
<?php $hidden = array('_method' => 'EDIT', '_token' => $invoice_id, 'invoice_id' => $invoice_id);?>
<?php echo form_open('admin/finance/add_direct_invoice_payment/'.$invoice_id, $attributes, $hidden);?>
<?php endif;?>
...
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        <label for="award_type"><?php echo $this->lang->line('tat_acc_account');?></label>
        <select name="bank_cash_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_choose_account_type');?>">
          <option value=""></option>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="deposit_date"><?php echo $this->lang->line('tat_e_details_date');?></label>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="employee"><?php echo $this->lang->line('tat_acc_payer');?></label>
            <select name="payer_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_payer');?>">
              <option value=""></option>
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('tat_description');?>" name="description" cols="30" rows="5" id="description2"></textarea>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="payment_method"><?php echo $this->lang->line('tat_payment_method');?></label>
            <select name="payment_method" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_payment_method');?>">
              <option value=""></option>
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="employee"><?php echo $this->lang->line('tat_acc_ref_no');?></label>
            <input class="form-control" placeholder="<?php echo $this->lang->line('tat_acc_ref_example');?>" name="reference" type="text" value="">
            <br />
          </div>
        </div>
      </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_acc_edit_deposit');?></h4>
</div>
...
<?php echo form_open('admin/finance/transaction_update/'.$deposit_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        <label for="award_type"><?php echo $this->lang->line('tat_acc_account');?></label>
        <select name="bank_cash_id" disabled="disabled" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_choose_account_type');?>">
          <option value=""></option>
          <?php foreach($all_bank_cash as $bank_cash) {?>
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label for="description"><?php echo $this->lang->line('tat_description');?></label>
        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('tat_description');?>" name="description" cols="30" rows="5" id="description2"><?php echo $description;?></textarea>
      </div>
      <div class='form-group'>
        <div>
          <label for="photo"><?php echo $this->lang->line('tat_acc_attach_file');?></label>
        </div>
        <span class="btn btn-primary btn-file"> <?php echo $this->lang->line('tat_browse');?>
        <input type="file" name="deposit_file" id="deposit_file">
        </span>
        <?php if($deposit_file!='' && $deposit_file!='no_file'):?>
        <br>
        <a href="<?php echo site_url('admin/download')?>?type=accounting/deposit&filename=<?php echo $deposit_file;?>"><?php echo $this->lang->line('tat_download');?></a>
        <?php endif;?>
      </div>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="employee"><?php echo $this->lang->line('tat_acc_ref_no');?></label>
        <input class="form-control" placeholder="<?php echo $this->lang->line('tat_acc_ref_example');?>" name="deposit_reference" type="text" value="<?php echo $deposit_reference;?>">
        <br />
      </div>
    </div>
  </div>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var tat_table = $('#tat_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php if($_GET['inv']==0){ echo site_url("admin/finance/transaction_list");} else { echo site_url("admin/invoices/invoice_payment_list"); } ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $attributes = array('name' => 'deposit_update', 'id' => 'deposit_update', 'autocomplete' => 'off');?>
<?php $hidden = array('_method' => 'EDIT', '_token' => $deposit_id, 'ext_name' => $deposit_id);?>
<?php echo form_open('admin/finance/deposit_update/'.$deposit_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var tat_table = $('#tat_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/finance/deposit_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_edit_expense');?></h4>
</div>
...
<?php echo form_open('admin/finance/expense_update/'.$expense_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-7">
      <div class="form-group">
        ...
        <?php if($user_info[0]->user_role_id==1 || in_array('314',$role_resources_ids)){ ?>
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="company" id="aj_companyx" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('module_company_title');?>" required>
    ...
    <div class="col-md-5">
      ...
      <div class='form-group'>
        ...
        <br>
        <a href="<?php echo site_url('admin/download')?>?type=accounting/expense&filename=<?php echo $expense_file;?>"><?php echo $this->lang->line('tat_download');?></a>
        <?php endif;?>
      </div>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <input class="form-control" placeholder="<?php echo $this->lang->line('tat_acc_ref_example');?>" name="expense_reference" type="text" value="<?php echo $expense_reference;?>">
        <br />
      </div>
    </div>
  </div>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var tat_table = $('#tat_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/finance/expense_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="employee"><?php echo $this->lang->line('tat_acc_payee');?></label>
            <select name="payee_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_payee');?>">
              <option value=""></option>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var tat_table = $('#tat_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/finance/transaction_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_edit_transfer');?></h4>
</div>
...
<?php echo form_open('admin/finance/transfer_update/'.$transfer_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-3">
      <div class="form-group">
        <label for="bank_cash_id"><?php echo $this->lang->line('tat_acc_from_account');?></label>
        <select disabled="disabled" name="from_bank_cash_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_choose_account_type');?>">
          <option value=""></option>
          <?php foreach($all_bank_cash as $bank_cash) {?>
      ...
      <div class="form-group">
        <label for="transfer_date"><?php echo $this->lang->line('tat_e_details_date');?></label>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="bank_cash_id"><?php echo $this->lang->line('tat_acc_to_account');?></label>
        <select disabled="disabled" name="to_bank_cash_id" id="select2-demo-6" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_choose_account_type');?>">
          <option value=""></option>
          <?php foreach($all_bank_cash as $bank_cash) {?>
      ...
      <div class="form-group">
        <label for="transfer_reference"><?php echo $this->lang->line('tat_acc_ref_no');?></label>
        <input class="form-control" placeholder="<?php echo $this->lang->line('tat_acc_ref_example');?>" name="transfer_reference" type="text" value="<?php echo $transfer_reference;?>">
        <br />
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label for="description"><?php echo $this->lang->line('tat_description');?></label>
        <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('tat_description');?>" name="description" cols="30" rows="15" id="description2"><?php echo $description;?></textarea>
      </div>
    </div>
  </div>
</div>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var tat_table = $('#tat_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/finance/transfer_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_acc_edit_payer');?></h4>
</div>
...
<?php echo form_open('admin/finance/update_payer/'.$payer_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        <label for="payer_name"><?php echo $this->lang->line('tat_acc_payer');?></label>
        <input type="text" class="form-control" name="payer_name" placeholder="<?php echo $this->lang->line('tat_acc_payer_name');?>" value="<?php echo $payer_name;?>">
      </div>
      <div class="form-group">
        <label for="contact_number"><?php echo $this->lang->line('tat_contact_number');?></label>
        <input type="text" class="form-control" name="contact_number" placeholder="<?php echo $this->lang->line('tat_contact_number');?>" value="<?php echo $contact_number;?>">
      </div>
    </div>
  </div>
</div>
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var tat_table = $('#tat_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("admin/finance/payers_list") ?>",
								type : 'GET'
							},
							"fnDrawCallback": function(settings){
							$('[data-toggle="tooltip"]').tooltip();          
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('tat_acc_edit_payee');?></h4>
</div>
...
<?php echo form_open('admin/finance/update_payee/'.$payee_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        <label for="payee_name"><?php echo $this->lang->line('tat_acc_payee');?></label>
        <input type="text" class="form-control" name="payee_name" placeholder="<?php echo $this->lang->line('tat_acc_payee_name');?>" value="<?php echo $payee_name;?>">
      </div>
      <div class="form-group">
        <label for="contact_number"><?php echo $this->lang->line('tat_contact_number');?></label>
        <input type="number" class="form-control" name="contact_number" placeholder="<?php echo $this->lang->line('tat_contact_number');?>" value="<?php echo $contact_number;?>">
      </div>
    </div>
  </div>
</div>
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var tat_table = $('#tat_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("admin/finance/payees_list") ?>",
								type : 'GET'
							},
							"fnDrawCallback": function(settings){
							$('[data-toggle="tooltip"]').tooltip();          
