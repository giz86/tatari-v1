<?php
// Ledger Account List View - Finance Module
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"><?php echo $this->lang->line('tat_acc_transactions').' '.$this->lang->line('tat_acc_ledger_account_of').' <strong>'.$acc_bal[0]->account_name.'</strong>';?></h3>
  </div>
  <div class="box-body">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="tat_table">
        ...
        <thead>
          ...
          <tr>
              ...
              <th>&nbsp;</th><th>&nbsp;</th>
              <th><?php echo $this->Tat_model->currency_sign($acc_bal[0]->account_opening_balance);?></td>
            </tr>
        </thead>
        <tbody>
		...
		?>
          <tr>
            ...
            <td><?php echo $this->Tat_model->currency_sign($crd); ?></td>
            <td><?php echo $this->Tat_model->currency_sign($deb); ?></td>
            <td><?php echo $this->Tat_model->currency_sign($fbalance);?></td>
          </tr>
         <?php } ?> 
        </tbody>
        <tfoot>
          <tr>
            <th colspan="3">&nbsp;</th>
            <th><?php echo $this->lang->line('tat_acc_credit');?>: <?php echo $this->Tat_model->currency_sign($crd_total);?></th>
            <th><?php echo $this->lang->line('tat_acc_debit');?>: <?php echo $this->Tat_model->currency_sign($deb_total);?></th>
            <th><?php echo $this->lang->line('tat_acc_balance');?>: <?php echo $this->Tat_model->currency_sign($acc_bal[0]->account_balance);?></th>
          </tr>
        </tfoot>
      </table>
