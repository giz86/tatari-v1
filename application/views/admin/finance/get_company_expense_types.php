...
<div class="form-group">
   ...
   <select required name="category_id" id="category_id" class="form-control" data-plugin="select_tat" data-placeholder="<?php echo $this->lang->line('tat_acc_category');?>">
    <option value=""><?php echo $this->lang->line('tat_acc_category');?></option>
