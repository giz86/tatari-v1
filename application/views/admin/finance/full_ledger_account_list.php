<?php
// List of Ledger Accounts - Finance Module
...
<div class="box mb-4 <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('tat_acc_statement_period');?> </h3>
  </div>
  <div class="box-body">
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"><?php echo $this->lang->line('tat_acc_ledger_accounts');?></h3>
  </div>
  <div class="box-body">
