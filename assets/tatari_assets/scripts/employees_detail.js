...
//$('#tatload-img').hide();
	...
	// On page load 
	var tat_table_allowances_ad = $('#tat_table_all_allowances').dataTable({
        "bDestroy": true,
		"ajax": {
	...
	var tat_table_commissions_ad = $('#tat_table_all_commissions').dataTable({
        "bDestroy": true,
		"ajax": {
	...
	var tat_table_statutory_deductions_ad = $('#tat_table_all_statutory_deductions').dataTable({
        "bDestroy": true,
		"ajax": {
	...
	var tat_table_other_payments_ad = $('#tat_table_all_other_payments').dataTable({
        "bDestroy": true,
		"ajax": {
